...
This repository contains Python scripts used to investigate potential time-domain observing strategies for the Fred Young Submillimeter Telescope (FYST) using the MARIA simulation framework.
